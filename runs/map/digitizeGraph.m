...
%May, 2012 Main Line.
function digitizedData=digitizeGraph(imageName,numberPoints,outFile)
...
%save the data
fprintf('The digitized data file is saved as %s.',outFile);
save(outFile,'digitizedData','-ascii');